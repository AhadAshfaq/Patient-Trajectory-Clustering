...
RUN_FLAGS = {
    ...
    "AGG_MANHATTAN_UNIMPUTED": False,

    # Agglomerative Clustering using Manhattan Distance matrix (Unimputed Normalized vector)
    "AGG_MANHATTAN_UNIMPUTED_NORMALIZED": True, 

    # Agglomerative Clustering using Manhattan Distance matrix (Imputed vector)
    "AGG_MANHATTAN_IMPUTED": False ,

    # Agglomerative Clustering using Cosine Distance matrix (Unimputed vector)
    "AGG_COSINE_UNIMPUTED": False,

    # Agglomerative Clustering using Cosine Distance matrix (Unimputed Normalized vector)
    "AGG_COSINE_UNIMPUTED_NORMALIZED": False,
    
    # Agglomerative Clustering using Cosine Distance matrix (Imputed vector)
    "AGG_COSINE_IMPUTED": False,

    # Agglomerative Clustering using Mahalanobis Distance matrix (Unimputed vector)
    "AGG_MAHALANOBIS_UNIMPUTED": False,

    # Agglomerative Clustering using Mahalanobis Distance matrix (Unimputed Normalized vector)
    "AGG_MAHANONBIS_UNIMPUTED_NORMALIZED": False,

    # Agglomerative Clustering using Mahalanobis Distance matrix(Imputed vector)
    "AGG_MAHALANOBIS_IMPUTED": False,

    # Agglomerative Clustering using precomputed Euclidean Distance matrix (Unimputed vector)
    "AGG_EUCLID_UNIMPUTED": False,

    # Agglomerative Clustering using precomputed Euclidean Distance matrix (Unimputed Normalized vector)
    "AGG_EUCLID_UNIMPUTED_NORMALIZED": True,
    
    # Agglomerative Clustering using precomputed Euclidean Distance matrix (Imputed vector)
    "AGG_EUCLID_IMPUTED": False,
