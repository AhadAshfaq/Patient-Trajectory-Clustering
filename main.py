...
# =========================
    ...
    if utils.should_run("SPECTRAL", RUN_ALL, RUN_FLAGS):
        ...
        for key, fisher_df in all_fisher.items():
            ...
            fisher_csv_path = os.path.join(spectral_dir, f"Spectral_fisher_test_{key}.csv")
            fisher_df.to_csv(fisher_csv_path, index=False)
            ...
            assignment_csv_path = os.path.join(spectral_dir, f"Spectral_cluster_assignments_k={k}.csv")
